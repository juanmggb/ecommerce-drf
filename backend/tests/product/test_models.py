...
# from product.models import IsActiveQueryset
...
class TestCategoryModel:
    ...
    def test_category_active_only_true(self, category_factory):
...
class TestProductModel:
    ...
    def test_return_product_acvtive_only_true(self, product_factory):
...
class TestProductImageModel:
    def test_str_method(self, product_image_factory, product_line_factory):
        ...
        obj = product_image_factory(order=1, productline=obj1)
        assert obj.__str__() == "12345_img"

    def test_alternative_test_feild_length(self, product_image_factory):
